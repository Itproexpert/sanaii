...
[![](https://img.shields.io/github/v/release/Itproexpert/3x-ui.svg)](https://github.com/Itproexpert/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/Itproexpert/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/Itproexpert/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/Itproexpert/3x-ui/total.svg)](#)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Itproexpert/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Itproexpert/3x-ui/master/install.sh) v1.7.8
```
...
wget https://github.com/Itproexpert/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. Clone the Project Repository:
   ...
   ```sh
   git clone https://github.com/Itproexpert/3x-ui.git
   cd 3x-ui
   ```
...
3. Start the Service
   ...
   docker run -itd \
      ...
      --name 3x-ui \
      ghcr.io/Itproexpert/3x-ui:latest
   ```
...
[![Stargazers over time](https://starchart.cc/Itproexpert/3x-ui.svg)](https://starchart.cc/Itproexpert/3x-ui)
