...
[![](https://img.shields.io/github/v/release/Itproexpert/sanaii.svg)](https://github.com/Itproexpert/sanaii/releases)
[![](https://img.shields.io/github/actions/workflow/status/Itproexpert/sanaii/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/Itproexpert/sanaii.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/Itproexpert/sanaii/total.svg)](#)
[![License](https://img.shields.io/badge/license-GPL%20V3-blue.svg?longCache=true)](https://www.gnu.org/licenses/gpl-3.0.en.html)

sanaii panel supporting multi-protocol, **Multi-lang (English,Farsi,Chinese,Russian,Vietnamese)**
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Itproexpert/sanaii/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Itproexpert/sanaii/master/install.sh) v1.7.8
```
...
wget https://github.com/Itproexpert/sanaii/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. Clone the Project Repository:
   ...
   ```sh
   git clone https://github.com/Itproexpert/sanaii.git
   cd sanaii
   ```
...
3. Start the Service
   ...
   docker run -itd \
      ...
      --name sanaii \
      ghcr.io/Itproexpert/sanaii:latest
   ```
...
[![Stargazers over time](https://starchart.cc/Itproexpert/sanaii.svg)](https://starchart.cc/Itproexpert/sanaii)
